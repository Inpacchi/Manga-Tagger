...
class Database:
    ...
    def insert(cls, data, logging_info=None):
        try:
            cls._log.info('Attempting to insert record into the database...')
        ...
        cls._log.info('Insertion was successful!')

    @classmethod
    def update(cls, search_filter, data, logging_info):
        try:
            cls._log.info('Attempting to update record in the database...')
        ...
        cls._log.info('Update was successful!')

    @classmethod
    def delete_all(cls, logging_info):
        try:
            cls._log.info('Attempting to delete all records in the database...')
